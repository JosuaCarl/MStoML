...
sbatch --partition=cpu3-long --time=14-00:00:00 --output ../../runs/ML/ml_gt_annot.out ML4com_run.py -t 200 -if 5 -of 6 -v 0 -st "../.." -s "annotated" -sam "Com8_grown_together" -b "tensorflow" -c "gpu" -n "cosine_2" -fn "FIA-Data Com8_20230717_P0024_msAV206-312.xlsx"

sbatch --partition=cpu3-long --time=14-00:00:00 --output ../../runs/ML/ml_gt_cos.out ML4com_run.py -t 200 -if 5 -of 6 -v 0 -st "../.." -s "latent" -sam "Com8_grown_together" -b "tensorflow" -c "gpu" -n "cosine_2" -fn "FIA-Data Com8_20230717_P0024_msAV206-312.xlsx"
sbatch --partition=cpu3-long --time=14-00:00:00 --output ../../runs/ML/ml_gt_maecos.out ML4com_run.py -t 200 -if 5 -of 6 -v 0 -st "../.." -s "latent" -sam "Com8_grown_together" -b "tensorflow" -c "gpu" -n "mae_cosine_2" -fn "FIA-Data Com8_20230717_P0024_msAV206-312.xlsx"
sbatch --partition=cpu3-long --time=14-00:00:00 --output ../../runs/ML/ml_gt_se.out ML4com_run.py -t 200 -if 5 -of 6 -v 0 -st "../.." -s "latent" -sam "Com8_grown_together" -b "tensorflow" -c "cpu" -n "se_2" -fn "FIA-Data Com8_20230717_P0024_msAV206-312.xlsx"
sbatch --partition=cpu3-long --time=14-00:00:00 --output ../../runs/ML/ml_gt_mae.out ML4com_run.py -t 200 -if 5 -of 6 -v 0 -st "../.." -s "latent" -sam "Com8_grown_together" -b "tensorflow" -c "cpu" -n "mae_2" -fn "FIA-Data Com8_20230717_P0024_msAV206-312.xlsx"

#sbatch --partition=cpu3-long --time=14-00:00:00 --output ../../runs/ML/ml_gt_aecos.out ML4com_run.py -t 200 -if 5 -of 6 -v 0 -st "../.." -s "latent" -sam "Com8_grown_together" -b "tensorflow" -c "cpu" -n "ae+cosine_2" -fn "FIA-Data Com8_20230717_P0024_msAV206-312.xlsx"
#sbatch --partition=cpu3-long --time=14-00:00:00 --output ../../runs/ML/ml_gt_mse.out ML4com_run.py -t 200 -if 5 -of 6 -v 0 -st "../.." -s "latent" -sam "Com8_grown_together" -b "tensorflow" -c "cpu" -n "mse_2" -fn "FIA-Data Com8_20230717_P0024_msAV206-312.xlsx"
