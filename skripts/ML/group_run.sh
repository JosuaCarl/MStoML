...
partition="cpu3-long"
time="14-00:00:00"
declare -a algorithms=( "Extreme gradient boosting RF" ) # "Decision tree" "Gaussian Naive-Bayes" "K-neighbours classifier" "Linear Discriminant Analysis" "Logistic Regression" "Neural Network (MLP) SK-learn" "Random forest" "Support-vector classifier" )
